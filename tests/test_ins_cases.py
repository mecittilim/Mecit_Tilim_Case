...
class Test_INS(CareersPage,QAPage):
    ...
    def test_INS_1(self):
        "Check that Insider home page is opened successfully."
    ...
    def test_INS_2(self):
        "Check that careers page's blocks are visible."
    ...
    def test_INS_3(self):
        ...
        # move to jobs to click as clean
        jobElement = self.driver.find_element(By.CSS_SELECTOR, QALocators.POSITION_ITEM_CSS)
        self.actions.move_to_element(jobElement).perform()
        ...
        # wait to releod job list after filtering
        self.waitElementToVisible(By.XPATH,QALocators.DEPARTMENT_TITLE_XPATH)
